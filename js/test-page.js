...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Выявление потенциально пригодных для жизни космических систем.", value: 1 }
    ],
    correctAnswer: 2
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: "определение последовательности действий, ведущих к получению результатов", value: 1 }
    ],
    correctAnswer: 2
  },
  {
    ...
    options: [
      ...
      { text: "Позволяет сразу перейти в конец тела цикла, пропуская весь код, который находится под ним", value: 1 }
    ],
    correctAnswer: 2
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Возможность объектов с одинаковой спецификацией иметь различную реализацию", value: 1 },
 ...
 const percentageScore = (totalScore / maxScore) * 100;
  ...
  const resultsData = {
    ...
    questions: questions.map((question, index) => ({
      ...
      userAnswer: question.options.find(option => option.value === userAnswers[index])?.text || 'No answer',
      correctAnswer: question.options[question.correctAnswer].text,
      isCorrect: userAnswers[index] === question.options[question.correctAnswer].value
    }))
  };
